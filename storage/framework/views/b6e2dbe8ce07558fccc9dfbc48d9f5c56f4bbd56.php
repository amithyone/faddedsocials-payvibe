...
<head>
    <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-E3CHRXC1NK"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-E3CHRXC1NK');
</script>
    <meta charset="utf-8">
...
<?php /**PATH /home/wolrdhome/public_html/core/resources/views/templates/basic/layouts/app.blade.php ENDPATH**/ ?>