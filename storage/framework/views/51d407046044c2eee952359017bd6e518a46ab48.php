...
<footer class="footer-area">
    ...
    <div class="bottom-footer py-3">
        <div class="container">
            <div class="row gy-3">
                <div class="col-sm-6">
                    <div class="bottom-footer__text"> &copy;  <?php echo date('Y') ?> . <?php echo app('translator')->get('Fadded-Socials'); ?>.</div>
                </div>
                <div class="col-sm-6">
...
<?php /**PATH /home/fadded/test.fadded-socials.com/core/resources/views/templates/basic/partials/footer.blade.php ENDPATH**/ ?>