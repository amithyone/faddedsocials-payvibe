...
<div class="subscribe">
    <button type="submit" class="subscribe-btn btn btn--base btn-sm" data-bs-toggle="modal"
        ...
        <span class="text"><?php echo app('translator')->get('Subscribe'); ?></span> <span class="icon"><i class="far fa-bell"></i></span>
    </button>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header img justify-content-end d-flex"
                style="background-image: url(<?php echo e(getImage('assets/images/frontend/subscribe/' . @$subscribe->data_values->image, '1000x525')); ?>);">
            ...
            <div class="modal-body pt-md-0 pb-5 px-4 px-md-5 text-center">
                <h2><?php echo e(__(@$subscribe->data_values->heading)); ?></h2>
                <div class="icon d-flex align-items-center justify-content-center">
                    <img src="<?php echo e(asset($activeTemplateTrue . 'images/email.png')); ?>" alt="" class="img-fluid">
                </div>
                <h4 class="mb-3"><?php echo e(__(@$subscribe->data_values->subheading)); ?></h4>
                <form action="#" class="subscribe-form">
                    <?php echo csrf_field(); ?>
                    <div class="form-group d-flex">
                        <input type="text" class="form--control rounded-left" name="email"
                            placeholder="<?php echo app('translator')->get('Enter email address'); ?>" required>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/wolrdhome/public_html/core/resources/views/components/subscribe-modal.blade.php ENDPATH**/ ?>