                                    ...
                                    <div class="col-12">
                                        <select class="form-control select select-has-icon" name="gateway" id="gateway" required>
                                            <?php $__currentLoopData = $gateway_currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($data->method_code); ?>" data-currency="<?php echo e($data->currency); ?>"><?php echo e($data->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $deposits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif($deposit->method_code == 107): ?>
                                        <p class="mb-0">Paystack</p>
                                    <?php elseif($deposit->method_code == 118): ?>
                                ...
                                <td>
                                <?php if($deposit->method_code == 118 && $deposit->status == 0): ?>
                                <a href="/user/xtrapay/verify/<?php echo e($deposit->trx); ?>"
...
<?php echo $__env->make($activeTemplate.'layouts.main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wolrdhome/public_html/core/resources/views/templates/basic/user/deposit_new.blade.php ENDPATH**/ ?>