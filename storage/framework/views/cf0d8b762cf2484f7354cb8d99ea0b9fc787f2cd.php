                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload1" class="bg--primary"><?php echo app('translator')->get('Select Light Logo'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="profilePicPreview logoPicPrev" style="background-image: url(<?php echo e(getImage(getFilePath('logoIcon').'/dark_logo.png', '?'.time())); ?>)">
                                                        <button type="button" class="remove-image"><i class="fa fa-times"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload2" class="bg--primary"><?php echo app('translator')->get('Select Dark Logo'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="image-upload">
                                    <div class="thumb">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload3" class="bg--primary"><?php echo app('translator')->get('Select Favicon'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fadded/public_html/core/resources/views/admin/setting/logo_icon.blade.php ENDPATH**/ ?>