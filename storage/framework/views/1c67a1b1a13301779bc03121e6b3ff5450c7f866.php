        ...
        <div class="row gy-4 align-items-center flex-wrap-reverse">
            <div class="col-lg-6 col-md-10 ">
                <div class="about-us__thumb">
                    <img src="<?php echo e(getImage('assets/images/frontend/about/' . @$about->data_values->image, '465x400')); ?>" alt="<?php echo app('translator')->get('image'); ?>">
                </div>
            </div>
...
<?php /**PATH /home/wolrdhome/public_html/core/resources/views/templates/basic/sections/about.blade.php ENDPATH**/ ?>