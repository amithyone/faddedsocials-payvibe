...
Route::post('xtrapay', 'Xtrapay\ProcessController@ipn')->name('Xtrapay');
Route::get('xtrapay/requery/{reference}', 'Xtrapay\ProcessController@checkTransaction')->name('XtrapayRequery');

Route::post('payaza', 'Payaza\ProcessController@ipn')->name('Payaza');
